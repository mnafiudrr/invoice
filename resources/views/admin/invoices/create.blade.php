            ...
            <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" id="invoice_number" name="invoice_number" value="{{ old('invoice_number') }}"
                           placeholder="INV-2026-001 (auto if blank)"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
                    ...
                    <select id="language" name="language" required
                        ...
                        <option value="id" @selected(old('language') === 'id')>Bahasa Indonesia</option>
                    </select>
                </div>
                <div>
                    <label for="currency" class="block text-sm font-medium text-gray-700">Currency</label>
                    <input type="text" id="currency" name="currency" value="{{ old('currency', 'IDR') }}" maxlength="3"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
                    <label for="issued_at" class="block text-sm font-medium text-gray-700">Invoice date</label>
                    <input type="date" id="issued_at" name="issued_at" value="{{ old('issued_at', now()->format('Y-m-d')) }}" required
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
                    <label for="due_at" class="block text-sm font-medium text-gray-700">Due date</label>
                    <input type="date" id="due_at" name="due_at" value="{{ old('due_at', now()->addDays(7)->format('Y-m-d')) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
            </div>
        </div>
        ...
        <div class="rounded-lg bg-white p-6 shadow">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" id="tax" name="tax" value="{{ old('tax', 0) }}"
                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
