...
<head>
    ...
    <style>
        ...
        .parties .company { font-weight: 700; font-size: 14px; }
        ...
        .notes, .terms { margin-top: 32px; }
        .notes h2, .terms h2 { font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #6b7280; margin: 0 0 6px; }
        .notes p, .terms p { font-size: 13px; margin: 0; white-space: pre-line; }
