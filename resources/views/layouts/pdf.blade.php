...
<head>
    ...
    <style>
        ...
        .paid-stamp { display: inline-block; color: rgba(22, 163, 74, 0.6); border: 9px solid rgba(22, 163, 74, 0.6); font-weight: 700; font-size: 102px; letter-spacing: 9px; text-transform: uppercase; padding: 12px 42px; border-radius: 12px; transform: translateY(50px) rotate(-25deg); -webkit-transform: translateY(50px) rotate(-25deg); }
